      ...
      <footer className="relative z-40 p-4 bg-black/40 backdrop-blur-xl flex-shrink-0">
        <div className="max-w-2xl mx-auto flex items-center bg-[#121212] rounded-full px-2 py-1.5 gap-2 shadow-xl border border-white/5 transition-all">
          ...
          {(newMessage.trim() || uploadLoading) && (
            <button
              onClick={sendMessage}
              className="flex items-center justify-center bg-purple-600 text-white rounded-full w-14 h-10 hover:bg-purple-500 transition-all active:scale-90 shadow-lg shadow-purple-500/30 animate-in slide-in-from-right-4 zoom-in duration-300 ease-out"
            >
              {uploadLoading ? (
